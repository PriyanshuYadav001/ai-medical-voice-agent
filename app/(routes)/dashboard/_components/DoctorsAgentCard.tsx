...
function DoctorsAgentCard({doctorAgent}:props) {
  ...
  return (
    <div className='relative'>
      ...
      onClick={onStartConsultation} disabled={!paidUser && doctorAgent.subscriptionRequired}>Start Consultation {loading?<Loader2Icon className='animate-spin'/>:<IconArrowRight/>}<IconArrowRight/></Button>
    </div>
  )
}
